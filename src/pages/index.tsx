  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="my first app - Revolutionizing the Way You Share Data. Experience seamless data sharing between users like never before with my first app."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1451187580459-43490279c0fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRhJTIwc2hhcmluZ3xlbnwwfHx8fDE2OTk4MTE2MjJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`my first app - Revolutionizing the Way You Share Data. Experience seamless data sharing between users like never before with my first app.`}
            </Text>
            <Box
